                    ...
                    <div className="row">
                        ...
                        <div className="col-md-9">
                          ...
                          <a href="#" className="float-right btn-tool"><i className="fas fa-times"></i></a>
                                                    ...
                                                    <span
                                                        className="description">Shared publicly - 7:30 PM today</span>
                                                </div>
                          ...
                          <a href="#" className="float-right btn-tool"><i className="fas fa-times"></i></a>
                                                    ...
                                                    <span
                                                        className="description">Sent you a message - 3 days ago</span>
                                                </div>
                          ...
                          10 Feb. 2014
                                                ...
                                                <div>
                                                    ...
                                                    <div className="timeline-item">
                                                        <span className="time"><i
                                                            className="far fa-clock"></i> 12:05</span>

                                                        <h3 className="timeline-header"><a href="#">Support
                                                ...
                                                <div>
                                                    ...
                                                    <div className="timeline-item">
                                                        ...
                                                        <h3 className="timeline-header"><a href="#">Jay
